...
export const CONTACT_PHONE = '8209760788';
...
export const COMPANY_TAGLINE = '"आओ चलें भारत की ओर"';

export const COMPANY_DESCRIPTION = 'Your Society Management Partner. Technology with human intervention—transforming apartments into professionally managed living ecosystems.';
